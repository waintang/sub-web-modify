  ...
  data() {
    return {
      ...
      options: {
        ...
        shortTypes: {
          "conv.20231010.xyz": "https://conv.20231010.xyz/short",
        ...
        customBackend: {
          "自用专属后端": "https://conv.20231010.xyz",// 为您的后端取名
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://conv.20231010.xyz" : this.getUrlParam(),
        shortType: "https://conv.20231010.xyz/short",
